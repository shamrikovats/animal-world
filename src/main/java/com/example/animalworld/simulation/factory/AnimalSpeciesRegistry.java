...
import com.example.animalworld.simulation.domain.species.herbivore.Buffalo;
import com.example.animalworld.simulation.domain.species.herbivore.Caterpillar;
import com.example.animalworld.simulation.domain.species.herbivore.Deer;
import com.example.animalworld.simulation.domain.species.herbivore.Goat;
import com.example.animalworld.simulation.domain.species.herbivore.Horse;
import com.example.animalworld.simulation.domain.species.herbivore.Rabbit;
import com.example.animalworld.simulation.domain.species.herbivore.Sheep;
import com.example.animalworld.simulation.domain.species.predator.Bear;
import com.example.animalworld.simulation.domain.species.predator.Boar;
import com.example.animalworld.simulation.domain.species.predator.Duck;
import com.example.animalworld.simulation.domain.species.predator.Eagle;
import com.example.animalworld.simulation.domain.species.predator.Fox;
import com.example.animalworld.simulation.domain.species.predator.Mouse;
import com.example.animalworld.simulation.domain.species.predator.Snake;
import com.example.animalworld.simulation.domain.species.predator.Wolf;
